      ...
      <div className=" flex flex-col max-h-[100%] space-y-28 items-center pt-52 md:text-left md:flex-row md:space-y-0 md:pt-0">
        ...
        <div className="px-0 pb-20 md:px-10 md:pt-8">
          <p className="text-base md:text-[18px]">
            ...
            la resolución de problemas y trabajo en equipo. Soy reconocido por
            mi lógica de programación y mi compromiso con la seguridad y
            privacidad de los usuarios. Busco una empresa que valore el trabajo
            en equipo y mis habilidades de resolución de problemas, donde pueda
            continuar creciendo como profesional. Estoy dispuesto a colaborar en
            la creación de soluciones innovadoras y eficientes que satisfagan
